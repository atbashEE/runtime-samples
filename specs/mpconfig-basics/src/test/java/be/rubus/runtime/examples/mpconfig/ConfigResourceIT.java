...
public class ConfigResourceIT extends AbstractAtbashTest {
    ...
    public void testConfigCachedAndProperties() {
        ...
        String keys = "PATH,java.specification.version,sun.jnu.encoding,java.class.path,language,java.vm.vendor,home.dir,ld.library.path,sun.arch.data.model,path,hostname,java.vendor.url,injected.value,user.timezone,LD_LIBRARY_PATH,jvm.args,os.name,java.vm.specification.version,PWD,stateless,sun.java.launcher,user.country,sun.boot.library.path,LANGUAGE,sun.java.command,MEM_MAX_RAM_PERCENTAGE,jdk.debug,mem.max.ram.percentage,sun.cpu.endian,user.home,user.language,shlvl,java.specification.vendor,java.version.date,java.home,file.separator,java.vm.compressedOopsMode,line.separator,HOME_DIR,java.specification.name,java.vm.specification.vendor,LC_ALL,DEPLOYMENT_DIR,pwd,SHLVL,ATBASH_ARGS,STATELESS,sun.management.compiler,CONFIG_FILE_LOCATION,java.runtime.version,runtime.logging.console,JAVA_HOME,mem.xss,user.name,MEM_XSS,path.separator,LANG,os.version,config.file.location,java.runtime.name,file.encoding,java.vm.name,java.vendor.version,lang,value,java.vendor.url.bug,jetty.git.hash,java.io.tmpdir,java.version,user.dir,os.arch,java.vm.specification.name,atbash.args,runtime.logging.verbose,mp.config.profile,home,java.util.logging.manager,java.library.path,java.vm.info,java.vendor,HOSTNAME,java.vm.version,JVM_ARGS,deployment.dir,sun.io.unicode.encoding,java.class.version,HOME,lc.all,atbash.config.log.JwtSupportConfiguration.disabled";
        ...
        Assertions.assertThat(foundKeys).contains(keys.split(","));
    }
